...
public class Form1 extends JFrame implements ActionListener{
	...
	Form1()
	{
		try
		{
			...
			con=DriverManager.getConnection("jdbc:mysql://localhost:3306/student","root","Karthik@1109");
			...
			System.out.println("Excecption raised");
			e.printStackTrace();
		}
	...
	public void actionPerformed(ActionEvent e)
	{
		if(e.getSource()==submitBt)
		{
			...
			String query=" insert into stu_table values ('"+name+"','"+rollno+"','"+state+"');";
			try
			{
